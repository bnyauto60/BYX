...
export interface AITextRequest {
  ...
  jsonMode?: boolean;
    ...
    /** Fournisseur choisi par l'atelier (Paramètres > Intelligence artificielle).
     * N'est utilisé par lib/ai/router.ts que si AI_TASK_ROUTING ne fixe pas déjà
     * un provider pour cette tâche précise — voir lib/ai/workshopProvider.ts. */
...
export interface AIVideoAnalysisRequest {
  ...
  realtime?: boolean;
    metadata?: Record<string, unknown>;
    /** Fournisseur choisi par l'atelier — voir AITextRequest.preferredProvider. */
  preferredProvider?: string;
}
